...
func newDoctorCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "doctor",
		Short: "Pre-flight system diagnostics and health checks",
		Long:  "Inspect system dependencies, network connectivity, and environment health.",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if report.HasErrors() {
				...
				if !fixOutput {
					fmt.Fprintf(out, "\n  %s  %s\n", iconWarn, warningStyle.Render("Run 'orbit doctor --fix' to automatically install missing dependencies."))
				}
			}
