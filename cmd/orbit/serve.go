...
func newServeCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "serve",
		Short: "Start the Orbit onboarding edge daemon and HTTP server",
		Long: `Runs the Orbit developer onboarding edge HTTP daemon.
...
func runServe(cmd *cobra.Command, opts *serveOptions) error {
	...
	fmt.Fprintln(out, titleStyle.Render("Orbit Onboarding Edge Daemon"))
